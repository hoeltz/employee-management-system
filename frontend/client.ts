 ...
 */
import {
    getSetting as api_admin_settings_getSetting,
    listSettings as api_admin_settings_listSettings,
    updateSetting as api_admin_settings_updateSetting
...
export namespace admin {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.listSettings = this.listSettings.bind(this)
         ...
         */
        public async getSetting(params: { key: string }): Promise<ResponseType<typeof api_admin_settings_getSetting>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/admin/settings/${encodeURIComponent(params.key)}`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_admin_settings_getSetting>
        }

        /**
         * Lists all settings.
         */
        public async listSettings(): Promise<ResponseType<typeof api_admin_settings_listSettings>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/admin/settings`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_admin_settings_listSettings>
        }
         ...
         * Updates a setting.
         */
        public async updateSetting(params: RequestType<typeof api_admin_settings_updateSetting>): Promise<ResponseType<typeof api_admin_settings_updateSetting>> {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_admin_settings_updateSetting>
        }
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { bulkUpload as api_employee_bulk_upload_bulkUpload } from "~backend/employee/bulk_upload";
...
import { seed as api_employee_seed_seed } from "~backend/employee/seed";
...
export namespace employee {
    ...
    export class ServiceClient {
         ...
         */
        public async bulkUpload(params: RequestType<typeof api_employee_bulk_upload_bulkUpload>): Promise<ResponseType<typeof api_employee_bulk_upload_bulkUpload>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/employees/bulk-upload`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_employee_bulk_upload_bulkUpload>
        }
        ...
        public async list(params: RequestType<typeof api_employee_list_list>): Promise<ResponseType<typeof api_employee_list_list>> {
            ...
            const query = makeRecord<string, string | string[]>({
                ...
                lokasiKerja: params.lokasiKerja,
         ...
         */
        public async seed(): Promise<ResponseType<typeof api_employee_seed_seed>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/employees/seed`, {method: "POST", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_employee_seed_seed>
        }
        ...
        public async update(params: RequestType<typeof api_employee_update_update>): Promise<ResponseType<typeof api_employee_update_update>> {
            ...
            const body: Record<string, any> = {
                ...
                foto:              params.foto,
                fotocopyIdentitas: params.fotocopyIdentitas,
                lokasiKerja:       params.lokasiKerja,
                mulaiBergabung:    params.mulaiBergabung,
                nama:              params.nama,
                posisi:            params.posisi,
            }
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { attendanceReport as api_reports_attendance_attendanceReport } from "~backend/reports/attendance";
import { invoiceReport as api_reports_invoice_invoiceReport } from "~backend/reports/invoice";
import { leaveReport as api_reports_leave_leaveReport } from "~backend/reports/leave";
...
export namespace reports {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            this.baseClient = baseClient
            this.attendanceReport = this.attendanceReport.bind(this)
            this.invoiceReport = this.invoiceReport.bind(this)
            this.leaveReport = this.leaveReport.bind(this)
        }

        /**
         * Generates attendance report for employees.
         */
        public async attendanceReport(params: RequestType<typeof api_reports_attendance_attendanceReport>): Promise<ResponseType<typeof api_reports_attendance_attendanceReport>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/reports/attendance`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_reports_attendance_attendanceReport>
        }

        /**
         * Generates invoice report for employees.
         */
        public async invoiceReport(params: RequestType<typeof api_reports_invoice_invoiceReport>): Promise<ResponseType<typeof api_reports_invoice_invoiceReport>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/reports/invoice`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_reports_invoice_invoiceReport>
        }

        /**
         * Generates leave report for employees.
         */
        public async leaveReport(params: RequestType<typeof api_reports_leave_leaveReport>): Promise<ResponseType<typeof api_reports_leave_leaveReport>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/reports/leave`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_reports_leave_leaveReport>
        }
    }
}
