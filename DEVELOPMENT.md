...
```bash
git remote add encore encore://employee-management-system-tuci
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/employee-management-system-tuci/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/employee-management-system-tuci/settings/integrations/github)
